...
```bash
sudo mkdir -p /srv/novel-deconstructor/runtime/{storage,uploads,outputs}
...
docker run -d \
  ...
  -v /srv/novel-deconstructor/runtime/storage:/app/backend/storage \
  -v /srv/novel-deconstructor/runtime/uploads:/app/backend/uploads \
  -v /srv/novel-deconstructor/runtime/outputs:/app/backend/outputs \
  -v /srv/novel-deconstructor/examples:/app/examples:ro \
